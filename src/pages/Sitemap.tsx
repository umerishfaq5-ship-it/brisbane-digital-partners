...
const sections = [
  ...
  /* 2 ─── SEO Services */
  {
    ...
    pages: [
      ...
      { label: "Technical SEO", href: "/services/technical-seo", desc: "Crawl efficiency, Core Web Vitals, structured data, and indexation fixes." },
      { label: "eCommerce SEO", href: "/services/ecommerce-seo", desc: "Product and category page SEO to drive organic revenue for online stores." },
      { label: "Link Building", href: "/services/link-building", desc: "Editorial backlinks, digital PR, and authority-building for Australian businesses." },
      { label: "AI SEO / GEO", href: "/services/ai-seo", desc: "Get cited by ChatGPT, Gemini, and Perplexity in AI-generated answers." },
      { label: "Enterprise SEO", href: "/services/enterprise-seo", desc: "Large-scale SEO for complex site architectures, multi-market strategy, and enterprise teams." },
      { label: "WordPress SEO", href: "/services/wordpress-seo", desc: "Yoast/RankMath configuration, WP architecture, and Core Web Vitals for WordPress sites." },
      { label: "Shopify SEO", href: "/services/shopify-seo", desc: "Fix Shopify's technical SEO limitations and build organic revenue for your store." },
      { label: "WooCommerce SEO", href: "/services/woocommerce-seo", desc: "Full technical and content SEO for WooCommerce stores on WordPress." },
      ...
      { label: "SEO Migration Services", href: "/services/seo-migration", desc: "Platform migrations with zero ranking loss and full 301 redirect coverage." },
      { label: "Small Business SEO", href: "/services/small-business-seo", desc: "Focused, affordable SEO for Australian SMBs and sole traders." },
      { label: "B2B SEO", href: "/services/b2b-seo", desc: "Buyer journey content and pipeline-quality organic leads for B2B companies." },
      { label: "SEO Consulting", href: "/services/seo-consulting", desc: "Senior SEO strategy, team training, and fractional Head of SEO engagements." },
      { label: "SEO Packages", href: "/services/seo-packages", desc: "Flexible SEO packages for Australian businesses — Local, Growth, and Enterprise tiers. No lock-in contracts." },
      { label: "On-Page SEO", href: "/services/on-page-seo", desc: "Title tags, headings, content and schema optimisation for every target page." },
      { label: "Content Marketing", href: "/services/content-marketing", desc: "SEO-integrated content strategy, keyword-driven blog posts, and topical authority building." },
      { label: "Email Marketing", href: "/services/email-marketing", desc: "Email automation, campaign management, and revenue generation for Australian businesses." },
      { label: "Facebook Advertising", href: "/services/facebook-ads", desc: "Full-funnel Meta Ads management — Facebook and Instagram advertising for Australian businesses." },
      ...
      { label: "PPC Agency Brisbane", href: "/services/ppc-brisbane", desc: "Brisbane-based PPC and Google Ads management — local expertise with measurable ROAS." },
  ...
  /* 2b --- Industry SEO */
  {
    ...
    color: "text-violet-600 dark:text-violet-400",
    bg: "bg-violet-500/10",
    description: "Sector-specific SEO strategies for Australian industries.",
    pages: [
      { label: "SEO for Tradies", href: "/industry/seo-for-tradies", desc: "Local SEO for plumbers, electricians, builders, and other Australian tradies." },
      { label: "SEO for Dentists", href: "/industry/seo-for-dentists", desc: "AHPRA-compliant dental SEO to drive new patient bookings from Google." },
      { label: "SEO for Lawyers", href: "/industry/seo-for-lawyers", desc: "Law firm SEO — practice area pages and local rankings to drive client enquiries." },
      { label: "SEO for Real Estate", href: "/industry/seo-for-real-estate", desc: "Suburb-level landing pages and area guides for real estate agencies." },
      { label: "Retail & eCommerce SEO", href: "/industry/retail-seo", desc: "Product and category page rankings to drive organic retail revenue." },
      { label: "Hospitality SEO", href: "/industry/hospitality-seo", desc: "Restaurant, hotel, and tourism SEO — Google Map Pack and local rankings." },
      { label: "Healthcare SEO", href: "/industry/healthcare-seo", desc: "YMYL-ready SEO for GPs, specialists, and allied health practices." },
      { label: "Accountant SEO", href: "/industry/accountant-seo", desc: "Service-specific rankings to attract accounting clients through Google." },
      { label: "Mortgage Broker SEO", href: "/industry/mortgage-broker-seo", desc: "Local SEO and ASIC-compliant content for Australian mortgage brokers." },
      { label: "Education SEO", href: "/industry/education-seo", desc: "Course-level rankings for universities, RTOs, TAFEs, and training providers." },
    ],
  },
  ...
  /* 6 ─── Location Pages */
  {
    ...
    pages: [
      ...
      { label: "SEO Agency Gold Coast, QLD", href: "/locations/gold-coast-seo", desc: "Local SEO, Map Pack rankings and suburb targeting for Gold Coast businesses." },
      { label: "SEO Agency Sunshine Coast, QLD", href: "/locations/sunshine-coast-seo", desc: "SEO for Australia's fastest-growing region — from Noosa to Caloundra." },
      ...
      { label: "SEO Agency Hobart, TAS", href: "/locations/hobart-seo", desc: "Less competitive than the mainland — faster rankings for Hobart and Tasmanian businesses." },
    ],
  },
