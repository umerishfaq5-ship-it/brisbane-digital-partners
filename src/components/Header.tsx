...
const seoMenu = {
  ...
  groups: [
    { heading: "SEO Services", items: [
      ...
      { label: "Off-Page SEO",             href: "/services/off-page-seo",            desc: "Authority building & link acquisition" },
...
const webMenu = {
  ...
  groups: [{ heading: "Web Development", items: [
    ...
    { label: "Maropost / Neto",        href: "/services/maropost-neto",           desc: "Maropost Commerce Cloud experts" },
    { label: "Squarespace / Wix",      href: "/services/squarespace-development", desc: "Premium creative websites" },
    { label: "Google Shopping",        href: "/services/google-shopping",         desc: "Shopping campaigns & feed management" },
...
const industriesMenu = {
  ...
  groups: [{ heading: "Industry SEO", items: [
    ...
    { label: "Mortgage Broker SEO",      href: "/industry/mortgage-broker-seo",    desc: "Lead gen for brokers & lenders" },
  ]}],
};
const locationsMenu = {
